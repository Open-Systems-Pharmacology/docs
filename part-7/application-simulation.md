...
- DDI 
    ...
    - Model Template Development
        - Hanke et al. describe a modeling network for the prediction of CYP3A4- and P-gp-mediated DDIs. The Supplementary Materials to this manuscript were compiled as one comprehensive reference manual with transparent documentation of the model performance to support DDI investigations during drug development, labeling, and submission for regulatory approval of new drugs [[106](../references.md#106)].
...
- Case-based strategies for different application scenarios
    - This work presents a systematic assessment of the current challenges to establishing confidence in PBPK models with respect to parameter estimation and model verification in each of the three major areas of PBPK application absorption prediction, exposure prediction in a target population, and DDI risk assessment during drug development [[124](../references.md#124)].
