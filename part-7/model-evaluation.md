...
2.	Development of a **Credibility Assessment Framework** [[137](../references.md#137)]  can assist you in defining, conducting, and evaluating the model performance requirements.
...
###### [Overview of the ASME V&V 40 risk‐informed credibility assessment framework](https://pmc.ncbi.nlm.nih.gov/articles/PMC6966181/); COU, context of use; V&V, verification and validation. 
...
3.	Goodness-of-fit diagnostics to consider during model development and for the final model evaluations include the following:
    ...
    3. Examples of model evaluation metrics applied in published PBPK analyses [[139](../references.md#139)], [[143](../references.md#143)]
    4. Strategies for model development and evaluation
        1. Case-based strategies for different application scenarios [[124](../references.md#124)]
...
4.	Acknowledge parameter value sources and expectations of reliability.  Use sensitivity analyses to evaluate the impact that variability or uncertainty in those values might have on model performance:
    ...
    2. PBPK and QSP modeling requires an understanding and acknowledgement of a priori (structural) and a posteriori (practical) identifiability, as well as characterization of uncertainty in the model parameters. Local and global sensitivity analyses can be used to quantify the influence of parameter variation on predictive performance. 
        ...
        2. An [open-source example of global sensitivity (Sobol) analysis](https://github.com/metrumresearchgroup/pbpk-qsp-mrgsolve/blob/master/docs/global_sensitivity_analysis.md) is available.
