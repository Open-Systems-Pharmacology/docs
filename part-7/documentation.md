...
Most of the commercial PBPK software offer a built-in tracking of parameter identification steps such as e.g. the [journal function](../part-5/working-journal.md) in OSP.
