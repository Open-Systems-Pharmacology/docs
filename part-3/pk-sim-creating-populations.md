...
to the NHANES study](../.gitbook/assets/BW_vs_age.png)
...
![Age dependence of the distribution in body mass index for white males according to the NHANES study](../.gitbook/assets/BMI_vs_age.png)

## Definition of new Populations in PK- Sim®

To create a new population, do one of the following:

* Click on **Population** <img src="../.gitbook/assets/Population.svg" alt="" data-size="line"> in the **Create** Group of the **Modeling & Simulation** Tab, or
* Right mouse click on **Populations** <img src="../.gitbook/assets/Population.svg" alt="" data-size="line">in the **Building Block Explorer** and select "Add Population...", or
...
* Create a population based on an individual saved as a template:
  * Click on **Load** <img src="../.gitbook/assets/LoadAction.svg" alt="" data-size="line"> in the **Demographics** tab next to the **Based on individual** drop-down menu.
...
* Create a new individual which serves as a basis individual for the population:
  * Click on **Create** <img src="../.gitbook/assets/AddAction.svg" alt="" data-size="line">
...
Selected parameters can be added to the box on the right hand side by clicking <img src="../.gitbook/assets/Next (1).svg" alt="" data-size="line"> **Add**. Accordingly, parameters can be removed from the box by clicking <img src="../.gitbook/assets/Back.svg" alt="" data-size="line"> **Remove**. Parameters added to the box on the right hand side can be varied within the population simulation. For each parameter, a type of distribution and associated properties of the distribution can be chosen. Four types of distributions are available:
...
![Dialog for extracting individuals from a populatoin](../.gitbook/assets/populations-extract-individuals.png)
...
4. Confirm and close the window with **OK** <img src="../.gitbook/assets/OK.svg" alt="" data-size="line">
