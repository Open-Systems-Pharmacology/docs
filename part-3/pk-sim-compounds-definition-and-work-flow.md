...
For acids and bases, the transcellular intestinal permeability can be calculated dynamically along the gastrointestinal tract based on local luminal pH and the compound’s pKa. By default, PK-Sim keeps the **Use pH- and pKa-dependent penalty factor for charged molecule fraction** disabled because the original intestinal permeability model (Pint) was calibrated without this penalty term and using membrane affinity data measured at approximately neutral pH; enabling the penalty factor in that framework degraded prediction quality for the underlying calibration set. This design choice and its background have been discussed within the OSP community and development team (see discussions in OSP Forum issue #25 [[174](../references.md#174)] and discussion #1816 [[175](../references.md#175)]).
