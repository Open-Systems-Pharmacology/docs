...
Clicking on the `Edit on GitHub` button will take you to the source file on GitHub.![Edit on GitHub](./assets/edit-github.png)

Next, click the pencil icon, as shown in the following figure to edit the article.![Edit](./assets/editicon.png)
...
![Propose file change](./assets/submit-pull-request.png)
...
![Open pull request](./assets/open-pull-request.png)
