...
Clicking on the `Edit on GitHub` button will take you to the source file on GitHub.![Edit on GitHub](<.gitbook/assets/edit-github (1).png>)

Next, click the pencil icon, as shown in the following figure to edit the article.![Edit](<.gitbook/assets/editicon (1).png>)
...
![Propose file change](<.gitbook/assets/submit-pull-request (1).png>)
...
![Open pull request](<.gitbook/assets/open-pull-request (1).png>)
