...
*   Click on the **File** tab and select ![Image](../assets/icons/ProjectNew.ico) **New Project** 
...
*   Double-click on the appearing building block ![Image](../assets/icons/MoleculeFolder.ico).

*   Right-click on the appearing building block and select ![Image](../assets/icons/Edit.ico) **Edit** from the context menu.
...
*   Click ![Image](../assets/icons/addaction.ico) **New** in the building block specific ribbon tab or right-click on the empty space in the building block (_Molecule List Tree View_) in the main window and select ![Image](../assets/icons/addaction.ico) **Create Molecule**.
...
*   In the diagram area, right-click anywhere and select ![Image](../assets/icons/Refresh.ico) **Refresh** in the context menu: the color of the green container named "Organism" should change to _blue_, which characterizes logical containers.

*   In the diagram area, right-click on the container named "Organism" and select ![Image](../assets/icons/ContainerAdd.ico) Create Container in the context menu.
...
*   Double-click on the new "Plasma" container. In the parameters tab below the diagram area click on the ![Image](../assets/icons/AddAction.ico) **Add Parameter** button.
...
*   To create a reaction, either click on ![Image](../assets/icons/reactionadd.ico) **New** in the building block specific ribbon tab or right-click on the empty space in the diagram area of the building block edit window and select ![Image](../assets/icons/ReactionAdd.ico) **Create Reaction**.

*   Add the molecules created in **Step 3**  by either clicking on ![Image](../assets/icons/MoleculeAdd.ico) **Insert Molecule** in the building block specific ribbon tab or right-clicking on the diagram area of the building block edit window and select ![Image](../assets/icons/MoleculeAdd.ico) **Insert Molecule**.
...
*   or right-click on the reaction symbol in the diagram area and select ![Image](../assets/icons/Edit.ico) **Edit** from the context menu.
...
Now select the formula string input box to the right of the yellow warning sign with the exclamation mark ![Image](../assets/icons/warning.ico) and enter the chosen reaction rate:
...
*   An explicit formula requires a name as indicated by the symbol ![Image](../assets/icons/ErrorProvider.ico).

*   The specified formula cannot be parsed due to the unknown entities: _k1_, _k2_, _Km_ and _V_ as indicated by the symbol ![Image](../assets/icons/Warning.ico).

First, a new formula has to be created. To create a new formula, click on the ![Image](../assets/icons/AddAction.ico) **Add Formula** button. A new window appears, where you can define a new name for the formula. Type in "r1" and confirm the name by clicking **OK**. The formula is also listed in the formula list in the formula tab located above the diagram area.

The yellow warning sign ![Image](../assets/icons/Warning.ico) indicates that the construction of our kinetic rate equation is not yet complete. To get a consistent formula, you need to assign the missing parameters to the reaction and add them to the referenced objects list.
...
|   |   |
|--- |--- |
| Alias | Defines the name by which the referenced objects are used in the Formula. If the name in the formula does not correspond to the Alias of the respective reference, a warning sign ![Image](../assets/icons/Warning.ico) appears. |
...
*   Click on the ![Image](../assets/icons/AddAction.ico) **Add Parameter** button.
...
*   Right-click on the molecule start values building block group in the building block explorer and select ![Image](../assets/icons/AddAction.ico) **Create Molecule Start Value Building Block** from the context menu.

*   In the appearing "Create new Start Values" window, define a name (here: "MSV") for the molecule start values building block and confirm by clicking **OK** ![Image](../assets/icons/OK.ico).
...
*   Click on ![Image](../assets/icons/Simulation.ico) **Create** in the _Simulation_ Group the _Modeling & Simulation_ ribbon tab.

*   In the appearing "Simulation Creation Wizard" window, specify a name for the simulation. Here: "RN".

*   Confirm the simulation creation process by clicking **Finish** ![Image](../assets/icons/OK.ico).
...
Now we can run the simulation. To run the simulation, click ![Image](../assets/icons/run.ico) **Run** in the simulation group of the modeling & simulation ribbon.
