...
1.  In the Simulation Explorer mark the two simulations "_Kaumeier IV 208 mg fit_" and "_Kaumeier oral solution 185mg_" and select ![](../assets/icons/ParameterIdentification.svg) **Start Parameter Identification ...** from the context menu.
...
*   Mark one ore more simulations for the Parameter Identification in the Simulation Explorer and select ![](../assets/icons/ParameterIdentification.svg)**Start Parameter Identification ...** from the context menu.

*   In the ribbon bar **Parameter Identification** click ![](../assets/icons/ParameterIdentification.svg) **Create** .

*   In the Simulation Explorer right click the Parameter Identification root node and select ![](../assets/icons/ParameterIdentification.svg) **Add Parameter Identification** from the context menu.
