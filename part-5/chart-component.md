...
In addition, a template can be loaded as .xml file using the <img width="32" src="../assets/icons/LoadAction.svg"> button.
...
In MoBi®, you can change the default editor layout and the default curve name generation in the **Chart Options** tab within the **User Settings** dialog (click <img width="32" src="../assets/icons/Settings.svg"> **Options** in the Utilities ribbon tab).
