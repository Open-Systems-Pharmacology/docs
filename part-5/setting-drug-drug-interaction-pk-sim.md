...
Further building blocks can be defined in the respective sections and a simulation is then created by clicking on the **Simulation** button in the **Create** group of the **Modeling** tab.
