...
MoBi can be customized using several options. To do this, click on the **Options** Button <img src="../.gitbook/assets/Settings.svg" alt="" data-size="line"> within the **Utilities** Ribbon Tab.
