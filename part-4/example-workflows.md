...
*   Export a simulation from PK-Sim to MoBi. This will create a PK-Sim module.
    ...
    ![Image](../.gitbook/assets/fig-01.png)
...
*   In the "Tumor" extension module: open the spatial structure and load the top container from the previously saved file Muscle.pkml.
    ...
    \{% hint style="note" %\} Note that the neighborhoods between muscle and arterial/venous blood are also loaded. \{% endhint %\}

    ![Image](../.gitbook/assets/fig-06.png)

    ![Image](../.gitbook/assets/fig-07.png)
*   Rename the "Muscle" container to "Tumor". **Be sure to check the "Rename Related Entities" checkbox in the next dialog!**.

    ![Image](../.gitbook/assets/fig-08.png)

    ![Image](../.gitbook/assets/fig-09.png)

    \{% hint style="note" %\} After renaming, the neighborhoods have been renamed accordingly. \{% endhint %\}

    ![Image](../.gitbook/assets/fig-10.png)
*   Open the Initial Conditions building block of the Tumor module and click on "Extend".

    ![Image](../.gitbook/assets/fig-11.png)
*   Select molecules to be incorporated into the tumor.

    ![Image](../.gitbook/assets/fig-12.png)

    ![Image](../.gitbook/assets/fig-13.png)
*   Create a new simulation and select both modules (make sure that the PK-Sim module is on top!).

    ![Image](../.gitbook/assets/fig-14.png)

In the next step, optionally select an Individual and Expression Profile(s).

![Image](../.gitbook/assets/fig-15.png)

*   The "Tumor" organ will now appear in the simulation.

    ![Image](../.gitbook/assets/fig-16.png)
*   Tumor drug concentrations, etc. can now be plotted in the simulation.

    ![Image](../.gitbook/assets/fig-17.png)

    ![Image](../.gitbook/assets/fig-18.png)
...
* Start MoBi®
*   Click on the **File** tab and select <img src="../.gitbook/assets/ProjectNew.svg" alt="" data-size="line"> **New Project**
...
* Double-click on the appearing building block <img src="../.gitbook/assets/MoleculeFolder.svg" alt="" data-size="line">.
* Right-click on the appearing building block and select <img src="../.gitbook/assets/Edit.svg" alt="" data-size="line"> **Edit** from the context menu.
...
* Click <img src="../.gitbook/assets/AddAction.svg" alt="" data-size="line"> **New** in the building block specific ribbon tab or right-click on the empty space in the building block (_Molecule List Tree View_) in the main window and select <img src="../.gitbook/assets/AddAction.svg" alt="" data-size="line"> **Create Molecule**.
...
* In the diagram area, right-click anywhere and select <img src="../.gitbook/assets/Refresh (1).svg" alt="" data-size="line"> **Refresh** in the context menu: the color of the green container named "Organism" should change to _blue_, which characterizes logical containers.
* In the diagram area, right-click on the container named "Organism" and select <img src="../.gitbook/assets/ContainerAdd.svg" alt="" data-size="line"> Create Container in the context menu.
...
* Double-click on the new "Plasma" container. In the parameters tab below the diagram area click on the <img src="../.gitbook/assets/AddAction.svg" alt="" data-size="line"> **Add Parameter** button.
...
* To create a reaction, either click on <img src="../.gitbook/assets/ReactionAdd.svg" alt="" data-size="line"> **New** in the building block specific ribbon tab or right-click on the empty space in the diagram area of the building block edit window and select <img src="../.gitbook/assets/ReactionAdd.svg" alt="" data-size="line"> **Create Reaction**.
* Add the molecules created in **Step 3** by either clicking on <img src="../.gitbook/assets/MoleculeAdd.svg" alt="" data-size="line"> **Insert Molecule** in the building block specific ribbon tab or right-clicking on the diagram area of the building block edit window and select <img src="../.gitbook/assets/MoleculeAdd.svg" alt="" data-size="line"> **Insert Molecule**.
...
* or right-click on the reaction symbol in the diagram area and select <img src="../.gitbook/assets/Edit.svg" alt="" data-size="line"> **Edit** from the context menu.
...
Now select the formula string input box to the right of the yellow warning sign with the exclamation mark <img src="../.gitbook/assets/Notifications.svg" alt="" data-size="line"> and enter the chosen reaction rate:
...
* An explicit formula requires a name as indicated by the symbol <img src="../.gitbook/assets/ErrorProvider.svg" alt="" data-size="line">.
* The specified formula cannot be parsed due to the unknown entities: _k1_, _k2_, _Km_ and _V_ as indicated by the symbol <img src="../.gitbook/assets/Notifications.svg" alt="" data-size="line">.

First, a new formula has to be created. To create a new formula, click on the <img src="../.gitbook/assets/AddAction.svg" alt="" data-size="line"> **Add Formula** button. A new window appears, where you can define a new name for the formula. Type in "r1" and confirm the name by clicking **OK**. The formula is also listed in the formula list in the formula tab located above the diagram area.

The yellow warning sign <img src="../.gitbook/assets/Notifications.svg" alt="" data-size="line"> indicates that the construction of our kinetic rate equation is not yet complete. To get a consistent formula, you need to assign the missing parameters to the reaction and add them to the referenced objects list.
...
|           |                                                                                                                                                                                                                                                                     |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Alias     | Defines the name by which the referenced objects are used in the Formula. If the name in the formula does not correspond to the Alias of the respective reference, a warning sign <img src="../.gitbook/assets/Notifications.svg" alt="" data-size="line"> appears. |
...
* Click on the <img src="../.gitbook/assets/AddAction.svg" alt="" data-size="line"> **Add Parameter** button.
...
* Right-click on the molecule start values building block group in the building block explorer and select <img src="../.gitbook/assets/AddAction.svg" alt="" data-size="line"> **Create Molecule Start Value Building Block** from the context menu.
* In the appearing "Create new Start Values" window, define a name (here: "MSV") for the molecule start values building block and confirm by clicking **OK** <img src="../.gitbook/assets/OK.svg" alt="" data-size="line">.
...
* Click on <img src="../.gitbook/assets/Simulation.svg" alt="" data-size="line"> **Create** in the _Simulation_ Group the _Modeling & Simulation_ ribbon tab.
* In the appearing "Simulation Creation Wizard" window, specify a name for the simulation. Here: "RN".
* Confirm the simulation creation process by clicking **Finish** <img src="../.gitbook/assets/OK.svg" alt="" data-size="line">.
...
Now we can run the simulation. To run the simulation, click <img src="../.gitbook/assets/Run.svg" alt="" data-size="line"> **Run** in the simulation group of the modeling & simulation ribbon.
...
{% hint style="info" %}
You can permanently dock the chart editor by clicking on the "pin" icon ![Image](../.gitbook/assets/AutoHideHide.png). Undock the chart editor by again clicking on the icon ![Image](../.gitbook/assets/AutoHideDock.png).
{% endhint %}
...
* Select both checkboxes ![Image](../.gitbook/assets/Checked.png) in the column **Used**.
