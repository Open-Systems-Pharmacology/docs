...
2.  Open the .pkml file using the **File** menu and choose the <img src="../assets/icons/Simulation.svg" data-size="line"> **Open Simulation** command.

3.  In the Simulations Explorer, double-click the <img src="../assets/icons/Simulation.svg" data-size="line"> **Simulation Icon** or the name of your simulation left to it.

4.  Click the run <img src="../assets/icons/Run.svg" data-size="line"> ribbon button of press the **F5** key. Wait until the calculation is done.
