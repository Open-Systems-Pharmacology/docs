...
Each observer has **container conditions** that define in which containers the observer will be created and a **list of molecules** that detefines for which molecules it will be created. Container conditions explained in [How Tags are used](model-building-components.md#) in detail. The list of molecules can either include all molecules or it can be restricted to a list of included or excluded molecules.
