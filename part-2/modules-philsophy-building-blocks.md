...
PK-Sim® and MoBi® can also import and export *project snapshots* in [JSON format](https://en.wikipedia.org/wiki/JSON) (s. [PK-Sim Snapshots](../part-3/pk-sim-snapshots.md) and [MoBi Snapshots](../part-4/mobi-snapshots.md) for details).