...
* Scaling of Individuals Scaling can be used to change the biometrics of an existing individual, i.e. an adult model may be scaled to an infant model while maintaining/scaling all specific modifications
...
* Administration Schemes:
  * Single
  * once daily, bi-daily, …
  * complex (multi-)periodic schemes ![](<.gitbook/assets/PKSim_Protocol_AdvancedEx (1).png>)
...
![](<.gitbook/assets/Tab_Data (1).png>) ![](<.gitbook/assets/Tab_Parameters (1).png>) ![](<.gitbook/assets/visual-feedback-data (1).jpg>) ![](<.gitbook/assets/Results_Calculation_Methods_Variation (1).png>)
...
* Calculation of time profile confidence intervals
  * **Confidence Interval**: Corresponds to the model error, which is based on the uncertainty of estimated parameters. This uncertainty is based on an estimation of the difference between the mean value of used observed data compared with the mean value of the (unknown) total data. ![](<.gitbook/assets/PI_ConfidenceInterval (1).png>)
  * **Visual Predictive Check Interval**: Corresponds to the uncertainty based on the data error. The data error is the standard deviation of the distribution of the used observed data. ![](<.gitbook/assets/PI_VPCCheckInterval (1).png>)
  * **Prediction Interval**: Corresponds to the combination of the model error and the data error. It shows how much future measured data are expected to differ from the model predictions. ![](<.gitbook/assets/PI_PredictionInterval (1).png>)
...
*   Sensitivity table:
    ...
    ![](<.gitbook/assets/SA_Results1 (1).png>)
*   Ranking of most sensitive simulation parameters. Most sensitive parameters comprise all parameters that contribute to 90% of total sensitivity.
    ...
    ![](<.gitbook/assets/SA_Ranking1 (1).png>)
...
* Roll-back / undo functionality ![](.gitbook/assets/image019.png)
...
* Plotting of all calculated time courses
  ...
  * Individual simulations:
    * Time profile plots ![](<.gitbook/assets/PK-Sim_CreateSimulation_RunSimulation_Results1 (1).png>)
  * Population simulations
    * Time profile plots ![](<.gitbook/assets/PK-Sim_CreateSimulation_PopSim_TimeProfile_Outputs (1).png>)

![](<.gitbook/assets/PK-Sim_CreateSimulation_PopSim_TimeProfile_Plot1 (1).png>) \* Box-Whisker plots ![](.gitbook/assets/image025.png) \* Range plots ![](.gitbook/assets/image027.png) \* Scatter plots ![](.gitbook/assets/image029.png)
