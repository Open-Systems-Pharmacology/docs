...
![Simulation Creation Wizard](../../.gitbook/assets/simcw.png)
...
* ![Image](../../.gitbook/assets/pdf-32x32.png) Export to PDF - generates a PDF report of the model \(see [Reporting](../../shared-tools-and-example-workflows/reporting.md)\).
