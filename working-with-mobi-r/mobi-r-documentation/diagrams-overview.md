...
* For the spatial structure and simulation, there is a **Diagram Overview** to the left of the diagram and above the model tree. Here, the current clipping is marked by a rectangular frame. You can pick this frame at its edge and move it to select the displayed clipping of the diagram, i.e., to scroll the diagram.
  ...
  ![Image](../../.gitbook/assets/diagramoverviewscroll.png)
...
* Click the **expand** symbol ![Image](../../.gitbook/assets/expandsymbol%20%282%29.png) in the top left corner of a container to expand the container. Except for the parent containers, the superstructure is often masked out for clarity.
* Click the **collapse** symbol ![Image](../../.gitbook/assets/collapsesymbol%20%282%29.png) to collapse a container. A possibly hidden superstructure is redisplayed.
...
* Press **Shift** and click ![Image](../../.gitbook/assets/collapsesymbol%20%281%29.png) to collapse a container without redisplaying hidden structures.
* Press **Ctrl** and click ![Image](../../.gitbook/assets/expandsymbol%20%281%29.png) / ![Image](../../.gitbook/assets/collapsesymbol.png) to expand resp. collapse a container recursively.
...
* Select ![Image](../../.gitbook/assets/newcontainer%20%281%29.png) **Create Container** from the **context menu** to add a new container \(or any other entity type\).
* Select ![Image](../../.gitbook/assets/loadcontainer.png) **Load Container** to load a previously saved container \(or any other entity type\).
* Select ![Image](../../.gitbook/assets/rename-32x32.png) **Rename** to rename an entity.
* Double click the entity or select ![Image](../../.gitbook/assets/edit-32x32.png) **Edit** from the context menu to focus and edit an entity.
* Select ![Image](../../.gitbook/assets/save-32x32.png) **Save** to save an entity separate from the project. You can load such entities in the same or into other projects.
* Select ![Image](../../.gitbook/assets/cancel.png) **Remove** to remove an entity.
...
* Select ![Image](../../.gitbook/assets/undo-32x32.png) **Undo Diagram Layout change** to undo diagram changes like collapse/expand or auto layout. Model changes break the undo sequence, and also hide/show cannot be undone. Observe that the **History Manager** only stores model changes but not diagram changes.
* Select ![Image](../../.gitbook/assets/forward.png) **Diagram / To front** or ![Image](../../.gitbook/assets/back.png) **Diagram / To back** to bring an element into front resp. back of another element/container in case of overlapping of containers and other nodes.
* Select ![Image](../../.gitbook/assets/update.png) **Refresh** to refresh a diagram, for example after changing the Diagram Options \(see [Display Changes](diagrams-overview.md#display-changes)\).
...
tab within the **User Settings** dialog \(click ![Image](../../.gitbook/assets/usersettings.png) **Options** in the Utilities ribbon tab\).
