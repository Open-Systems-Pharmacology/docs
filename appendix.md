...
Age in years | year(s) | year(s)
Age in weeks | week(s) | week(s)
Amount | µmol | µmol
Amount per time | µmol/min | µmol/min
Area | dm² | cm²
AUC (mass) | kg*min/l | µg*min/l
AUC (molar) | µmol*min/l | µmol*min/l
AUCM (molar) | µmol*min²/l | µmol*min²/l
BMI | kg/dm² | kg/m²
...
Concentration (molar) | µmol/l | µmol/l
Inversed concentration (molar) | l/µmol | l/µmol
Concentration (molar) per time | µmol/l/min | µmol/l/min
Compliance | l/(kg/(dm*min²)) | ml/mmHg
Compliance (Area) | dm²/(kg/(dm*min²)) | cm²/mmHg
Count | x10^6 | x10^6
Count per mass | x10^6/kg | x10^6/g
Count per volume | x10^6/l | x10^6/ml
CV Viscosity | kg/(dm*min) | s*mmHg
CV Viscosity per Volume | (kg/(dm*min))/l | s*mmHg/ml
CV mmHg*s²/ml | (kg/dm)/l | mmHg*s²/ml
Density | kg/dm³ | g/cm³
Diffusion coefficient | dm²/min | cm²/min
Dose per body weight | kg/kg | mg/kg
Dose per body surface area | kg/dm² | mg/m²
Elastance | (kg/(dm*min²))/l | mmHg/ml
Energy | kg*dm²/min² | kcal
Flow | l/min | l/min
Flow per weight organ | l/min/kg organ | ml/min/100g organ
Flow per weight | l/min/kg | ml/min/kg
Flow per body surface area | l/min/dm² | ml/min/1.73m²
Flow² | (l/min)² | (l/min)²
Fraction |  | 
Hydraulic conductivity | l/min/(kg*dm/min²) | ml/min/N
Inversed length | 1/dm | 1/cm
Inversed mol | 1/µmol | 1/mol
Inversed time | 1/min | 1/min
Inversed volume | 1/l | 1/l
Length | dm | cm
Log Units | Log Units | Log Units
Mass | kg | kg
Mass per area | kg/dm² | µg/cm²
Mass per time | kg/min | kg/min
Mass per area per time | kg/dm²/min | µg/cm²/h
...
Second order rate constant | l/µmol/min | l/µmol/min
...
Vmax per weight organ tissue | µmol/min/kg tissue | µmol/min/kg tissue
