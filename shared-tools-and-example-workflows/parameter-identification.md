...
1. In the Simulation Explorer mark the two simulations "_Kaumeier IV 208 mg fit_" and "_Kaumeier oral solution 185mg_" and select ![Image](https://github.com/Open-Systems-Pharmacology/docs/tree/12664bcb5d808f9cf23ed6faef1d38c669b0ac27/assets/images/part-5/ParameterIdentification.png)**Start Parameter Identification ...** from the context menu.
...
4. Now the **Visual Feedback Window** shows the intermediate state during the Parameter Identification Run.
   ...
   ![Parameter Identification - Visual Feedback data](../.gitbook/assets/visualfeedback.png)
...
* Mark one ore more simulations for the Parameter Identification in the Simulation Explorer and select ![Image](../.gitbook/assets/parameteridentification%20%283%29.png)**Start Parameter Identification ...** from the context menu.
* In the ribbon bar **Parameter Identification** click ![Image](../.gitbook/assets/parameteridentification%20%281%29.png) **Create** .
* In the Simulation Explorer right click the Parameter Identification root node and select ![Image](../.gitbook/assets/parameteridentification%20%282%29.png) **Add Parameter Identification** from the context menu.
...
Henri P. Gavin: "The Levenberg-Marquardt method for nonlinear least squares curve-fitting problems" \(May 2016\) [http://www.people.duke.edu/~hpgavin/\(http://www.people.duke.edu/~hpgavin/ce281/lm.pdf](http://www.people.duke.edu/~hpgavin/%28http://www.people.duke.edu/~hpgavin/ce281/lm.pdf)\) ce281/lm.pdf
...
![Parameter Identification - Results data](../.gitbook/assets/tab_results%20%281%29.png)
