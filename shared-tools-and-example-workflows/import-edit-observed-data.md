...
* The ![Image](../.gitbook/assets/IconMetaData.png) icon indicates that meta data are requested.
...
![Imported Table Tab Page](../.gitbook/assets/ImportTableTabPage.png)
...
Once a repository of observed data is imported, it can be manipulated by adding new data points, numerically changing data points or changing meta data. Changes are reversible through ![](../.gitbook/assets/Undo.ico) and will be tracked in the project history. Numerically changing a value is reflected in real time in the preview graph below and will result in moving the data point in the data grid to the new settings
