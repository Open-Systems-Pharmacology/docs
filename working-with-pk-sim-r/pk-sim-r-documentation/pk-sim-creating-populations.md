...
![Age dependence of the distribution in body weight for white males according to the NHANES study](../../.gitbook/assets/bw_vs_age.png)
...
* Click on **Load** ![Image](../../.gitbook/assets/load.png)
