...
The content of this manual is naturally selected and biased. Systems biology includes many levels of biological diversity, but we will focus on organisms and topics of broader relevance in pharmaceutical research and development, i.e., systems pharmacology. However, many facets of the software can be used beyond systems pharmacology.
...
![Phases, costs, and biological systems used in drug development](<../.gitbook/assets/Kuepfer_et_al_Adv_Exp_Med_Biol_2012_Figure1 (1).jpg>)
